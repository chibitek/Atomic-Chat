...
import { Route as GlassDemoRouteImport } from './routes/glass-demo'
...
const GlassDemoRoute = GlassDemoRouteImport.update({
  id: '/glass-demo',
  path: '/glass-demo',
  getParentRoute: () => rootRouteImport,
} as any)
...
export interface FileRoutesByFullPath {
  '/': typeof IndexRoute
  '/glass-demo': typeof GlassDemoRoute
...
export interface RootRouteChildren {
  ...
  GlassDemoRoute: typeof GlassDemoRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/glass-demo': {
      ...
      path: '/glass-demo'
      fullPath: '/glass-demo'
      preLoaderRoute: typeof GlassDemoRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/': {
      id: '/'
